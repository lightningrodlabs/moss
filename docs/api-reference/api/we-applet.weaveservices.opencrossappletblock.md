...
[Home](./index.md) &gt; [@lightningrodlabs/we-applet](./we-applet.md) &gt; [WeaveServices](./we-applet.weaveservices.md) &gt; [openCrossAppletBlock](./we-applet.weaveservices.opencrossappletblock.md)
