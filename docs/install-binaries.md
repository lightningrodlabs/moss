...
cargo install holochain --version holochain-v0.2.4 --locked --features sqlite-encrypted
HOLOCHAIN_PATH=$(which holochain)
cp $HOLOCHAIN_PATH src-tauri/bins/holochain-v0.2.4-[_ARCHITECTURE_]
...
Copy-Item $HcPath -Destination src-tauri/bins/holochain-v0.2.4-x86_64-pc-windows-msvc.exe
