...
@localized()
@customElement('hrl-created-element')
export class HrlCreatedElement extends LitElement {
          ...
          return html`
            ...
            >
              ...
              <div
                ...
                title=${msg('Add to Pocket')}
                tabindex="0"
                @click=${() => {
                  this._weStore.hrlToClipboard(this.hrlWithContext);
