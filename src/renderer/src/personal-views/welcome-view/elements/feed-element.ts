  ...
  render() {
    ...
    return html`
      ...
      >
        <div
          class="row"
          style="align-items: center; justify-content: space-between; width: 100%; opacity: .7;"
        >
          <div style=" display: flex; align-items: center;">
            ...
            ></applet-title>
            <span style="font-size: 12px; display; inline-block; padding-left: 5px;"
              >- ${this.notification.notification.title}</span
            >
          </div>
          <span style="font-size: 12px; padding-right: 10px;"
            >${timeAgo.format(this.notification.notification.timestamp)}</span
          >
        </div>
        <div
          class="row"
